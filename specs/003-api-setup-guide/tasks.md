...
- [x] T003 Write the Prerequisites section in `docs/api-setup-guide.md` covering: (1) WHOOP Developer Portal registration and app creation, (2) obtaining Client ID and Client Secret, (3) configuring a Redirect URI in the portal, (4) a security warning to never commit client secrets to source control or logs. Use placeholder values (`<your-client-id>`, `<your-client-secret>`) throughout.
